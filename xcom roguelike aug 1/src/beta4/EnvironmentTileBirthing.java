...
public class EnvironmentTileBirthing {
	...
	toChange.representingCharSet(repChar);
	...
	toChange.representingColorBackSet(tempBack);
	toChange.representingColorFrontSet(tempFront);
	...
	toChange.dimensionsSet(new short[]{1,1,1});
